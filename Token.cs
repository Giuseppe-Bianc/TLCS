...
namespace TLCS {
	...
	public sealed class Token : IEquatable<Token> {
		...
		/// <summary> Inizializza una nuova istanza della classe <see cref="Token"/>. </summary>
		...
		/// <summary> Crea un token di fine file. </summary>
		/// <param name="linea">Il numero di riga in cui è stato trovato il token.</param>
		/// <param name="colonna">Il numero di colonna in cui inizia il token.</param>
		...
		/// <summary>Restituisce una rappresentazione testuale del token.</summary>
		...
		/// <summary> Determina se l'oggetto specificato è uguale al token corrente. </summary>
		...
		/// <summary> Determina se il token specificato è uguale al token corrente. </summary>
		...
		/// <summary> Serve come funzione hash per un tipo particolare, adatta per l'uso in algoritmi di hash e strutture dati come una tabella hash. </summary>
		...
		/// <summary> Checks whether two tokens are equal. </summary>
		...
		/// <summary> Checks whether two tokens are not equal. </summary>
		/// <param name="token1">The first token to compare.</param>
		/// <param name="token2">The second token to compare.</param>
